...
async function loadBlogs() {
    ...
    try {
        ...
        const response = await fetch('https://cyber-backend-nine.vercel.app/api/blogs');
...
function createBlogCard(blog) {
    ...
    if (blog.image) {
        imageUrl = blog.image.startsWith('http') ? blog.image : `https://cyber-backend-nine.vercel.app/${blog.image}`;
    }
